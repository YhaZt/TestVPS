    ...
    <div class="schedule-grid">
      <div v-for="schedule in schedules" :key="schedule._id" class="schedule-card">
        ...
        <div class="card-body">
          ...
          <p><strong>📊 Total Doses:</strong> {{ schedule.targetDays * schedule.frequencyPerDay }}</p>
          ...
          <div v-if="schedule.medicine?.requiresFood || schedule.medicine?.mustAvoid" class="medicine-info">
            <p v-if="schedule.medicine?.requiresFood" class="food-required">🍽️ Requires Food</p>
            <p v-if="schedule.medicine?.mustAvoid" class="avoid-text">⚠️ Avoid: {{ schedule.medicine.mustAvoid }}</p>
          </div>
        </div>
      </div>
    </div>
